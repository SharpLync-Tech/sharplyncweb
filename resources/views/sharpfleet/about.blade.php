...
<div class="card">
    <div class="card-body">
        ...
        <!-- Story -->
        <p>
            I started my own business and needed to log business trips.
        </p>
        ...
        <p>
            As it grew, I realised something else:
        </p>

        <p>
            <strong>Business owners should be the ones setting the rules.</strong>
        </p>
