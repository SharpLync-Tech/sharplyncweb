    ...
    <div class="sf-help__card">
        ...
        <div class="sf-help__actions">
            <form method="POST"
                ...
                @csrf
                <button class="btn-sf-navy btn-sm" type="submit">Re-run setup wizard</button>
            </form>
        </div>
    </div>
</section>
...
<section id="admin-setup-step-company" data-sf-help-section class="sf-help__section">
    ...
    <div class="sf-help__card">
        ...
        <div class="sf-help__actions">
            <a class="btn-sf-navy btn-sm" href="/app/sharpfleet/admin/setup/company">Open Step 1</a>
        </div>
...
<section id="admin-setup-step-presence" data-sf-help-section class="sf-help__section">
    ...
    <div class="sf-help__card">
        ...
        <div class="sf-help__actions">
            <a class="btn-sf-navy btn-sm" href="/app/sharpfleet/admin/setup/settings/presence">Open Step 2</a>
        </div>
        <div class="sf-help__callout sf-help__callout--important">
            <div class="sf-help__calloutTitle">Important</div>
...
<section id="admin-setup-step-trip-rules" data-sf-help-section class="sf-help__section">
    ...
    <div class="sf-help__card">
        ...
        <div class="sf-help__actions">
            <a class="btn-sf-navy btn-sm" href="/app/sharpfleet/admin/setup/settings/trip-rules">Open Step 3</a>
        </div>
        <div class="sf-help__callout sf-help__callout--recommended">
            <div class="sf-help__calloutTitle">Recommended</div>
...
<section id="admin-setup-step-vehicle-tracking" data-sf-help-section class="sf-help__section">
    ...
    <div class="sf-help__card">
        ...
        <div class="sf-help__actions">
            <a class="btn-sf-navy btn-sm" href="/app/sharpfleet/admin/setup/settings/vehicle-tracking">Open Step 4</a>
        </div>
        <div class="sf-help__callout">
...
<section id="admin-setup-step-reminders" data-sf-help-section class="sf-help__section">
    ...
    <div class="sf-help__card">
        ...
        <div class="sf-help__actions">
            <a class="btn-sf-navy btn-sm" href="/app/sharpfleet/admin/setup/settings/reminders">Open Step 5</a>
        </div>
        <div class="sf-help__callout">
...
<section id="admin-setup-step-client-addresses" data-sf-help-section class="sf-help__section">
    ...
    <div class="sf-help__card">
        ...
        <div class="sf-help__actions">
            <a class="btn-sf-navy btn-sm" href="/app/sharpfleet/admin/setup/settings/client-addresses">Open Step 6</a>
        </div>
    </div>
</section>
...
<section id="admin-setup-step-safety" data-sf-help-section class="sf-help__section">
    ...
    <div class="sf-help__card">
        ...
        <div class="sf-help__actions">
            <a class="btn-sf-navy btn-sm" href="/app/sharpfleet/admin/setup/settings/safety-check">Open Step 7</a>
            <a class="btn-sf-navy btn-sm" href="/app/sharpfleet/admin/safety-checks">Manage checklist</a>
        </div>
        <div class="sf-help__callout">
            <div class="sf-help__calloutTitle">Tip</div>
...
<section id="admin-setup-step-incident" data-sf-help-section class="sf-help__section">
    ...
    <div class="sf-help__card">
        ...
        <div class="sf-help__actions">
            <a class="btn-sf-navy btn-sm" href="/app/sharpfleet/admin/setup/settings/incident-reporting">Open Step 8</a>
        </div>
    </div>
</section>
...
<section id="admin-setup-step-finish" data-sf-help-section class="sf-help__section">
    ...
    <div class="sf-help__card">
        ...
        <div class="sf-help__actions">
            <a class="btn-sf-navy btn-sm" href="/app/sharpfleet/admin/setup/finish">Open Step 9</a>
        </div>
    </div>
</section>
...
<section id="admin-setup-next-vehicles" data-sf-help-section class="sf-help__section">
    ...
    <div class="sf-help__card">
        ...
        <div class="sf-help__actions">
            <a class="btn-sf-navy btn-sm" href="/app/sharpfleet/admin/vehicles">Open Vehicles</a>
        </div>
        <div class="sf-help__callout">
            <div class="sf-help__calloutTitle">Tip</div>
...
<section id="admin-setup-step-invite" data-sf-help-section class="sf-help__section">
    ...
    <div class="sf-help__card">
        ...
        <div class="sf-help__actions">
            <a class="btn-sf-navy btn-sm" href="/app/sharpfleet/admin/users">Open Users</a>
            <a class="btn-sf-navy btn-sm" href="/app/sharpfleet/admin/users/invite">Invite a driver</a>
        </div>
        <div class="sf-help__callout">
            <div class="sf-help__calloutTitle">Tip</div>
...
<section id="admin-ref-safety" data-sf-help-section class="sf-help__section">
    ...
    <details class="sf-help__details">
        ...
        <div class="sf-help__actions">
            <a class="btn-sf-navy btn-sm" href="/app/sharpfleet/admin/safety-checks">Open Safety Checks</a>
        </div>
    </details>
</section>
...
<section id="admin-ref-reports" data-sf-help-section class="sf-help__section">
    ...
    <details class="sf-help__details">
        ...
        <div class="sf-help__actions">
            <a class="btn-sf-navy btn-sm" href="/app/sharpfleet/admin/reports/trips">Open Trip Reports</a>
        </div>
    </details>
</section>
