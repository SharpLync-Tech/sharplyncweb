...
<section class="content-hero fade-in">
  ...
  <!-- ===================== -->
  <!-- My Story Section — FIXED -->
  <!-- ===================== -->

  <div class="about-story-card fade-section">

      <h3>My Story: From Tools to Technology</h3>

      <div class="about-story-content" id="storyIntro">
      ...
      <div class="about-story-content collapsed" id="storyFull">
      ...
      <button id="toggleStory">Continue My Story +</button>
