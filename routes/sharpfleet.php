...
Route::prefix('app/sharpfleet')
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Driver Mobile Routes (PWA - token auth)
    |--------------------------------------------------------------------------
    */
    Route::middleware([
        \App\Http\Middleware\MobileDriverTokenAuth::class,
        ...
        Route::get('/trips/active-for-vehicle', [TripController::class, 'activeForVehicle']);
        Route::post('/trips/end-handover', [TripController::class, 'endHandover']);
    ...
    /*
    |--------------------------------------------------------------------------
    | Driver Desktop Routes (session auth)
    |--------------------------------------------------------------------------
    */
    Route::middleware([
    ...
    */
    Route::middleware([
        ...
        Route::get('/admin/vehicles/{vehicle}/insurance-document/{documentId?}', [VehicleController::class, 'insuranceDocument'])
        ...
        Route::get(
            ...
            [AiReportBuilderController::class, 'index']
        )->name('sharpfleet.reports.ai-report-builder');

        Route::post(
            '/admin/reports/ai-report-builder',
            [AiReportBuilderController::class, 'generate']
        )->name('sharpfleet.reports.ai-report-builder.generate');
