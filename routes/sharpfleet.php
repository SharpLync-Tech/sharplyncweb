    ...
    */
    Route::middleware([\App\Http\Middleware\SharpFleetAdminAuth::class, \App\Http\Middleware\SharpFleetSetupWizard::class, \App\Http\Middleware\SharpFleetTrialCheck::class, \App\Http\Middleware\SharpFleetAuditLog::class])
        ...
        ->group(function () {
            ...
            Route::get('/trips/active', [AdminBookingController::class, 'activeTrips']);
            Route::post('/bookings', [AdminBookingController::class, 'store']);
            Route::post('/bookings/{booking}', [AdminBookingController::class, 'update'])->whereNumber('booking');
            ...
            Route::get('/bookings/feed', [AdminBookingController::class, 'feed']);
